...
namespace BloodDonationAPI.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        public UsersController(iDonorDbContext dbContext, IMapper mapper)
        {
...
/*            var userCreate = new User()
        ...
        [HttpPut]
        [Route("{userID:int}")]
        public async Task<IActionResult> UpdateUser([FromRoute] int userID, [FromBody] UserDto updatedUserDto)
        {
            if (updatedUserDto == null)
                return BadRequest(ModelState);

            if (userID != updatedUserDto.UserID)
                return BadRequest(ModelState);
            ...
            _mapper.Map(updatedUserDto, existingUser); // Map properties from UserDto to User
